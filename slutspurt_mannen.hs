...
spela speltillstond = do
    display ( InWindow "Nice Window" (200, 200) (10, 10)) white (ohmygoddrawingFunc (newDropMannen blue 1 0 speltillstond))
...
-- arrow består av en lista med koordinater och index för pilen som hela tiden uppdateras av playfunk
--arrow :: Picture
--arrow = pictures [rectangleSolid 1 10.0]
...
ohmygoddrawingFunc gs = pictures [rectangleSolid 1400 900, mkCircle (getcolor 16 gs ) 0 40, mkCircle (getcolor 10 gs) 150 140, mkCircle (getcolor 4 gs)  300 240, mkCircle (getcolor 5 gs ) 450 240, mkCircle (getcolor 11 gs ) 300 140, 
                                                           ...
                                                           mkSmallCircle green (-300) 320, mkSmallCircle green (-150) 320, mkSmallCircle green 0 320, mkSmallCircle green 150 320, mkSmallCircle green 300 320, mkSmallCircle green 450 320, mkSmallCircle green 600 320]
