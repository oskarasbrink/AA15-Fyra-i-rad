...
newCheckDiagonalRight color index tracker gs | tracker == 3 = True
                                             ...
                                             | newTraverseList index gs == color && newTraverseList (index - 6) gs == color  = newCheckDiagonalRight color (index -6) (tracker + 1) gs
...
newCheckDiagonalLeft color index tracker gs | tracker == 3 = True
                                            ...
                                            | newTraverseList index gs == color && newTraverseList (index - 8) gs == color = newCheckDiagonalLeft color (index - 8) (tracker +1 ) gs
